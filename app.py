...
def stamp_qr_code_on_pdf(pdf_bytes, url):
    ...
    for page in doc:
        ...
        rect = fitz.Rect(pw - margin - qr_size, ph - margin - qr_size, pw - margin, ph - margin)
...
def make_public_endpoint():
    ...
    try:
        ...
        try:
            ...
            upload_file_content(file_id, stamped_bytes, token)
        except Exception as qr_err:
            print(f"QR stamping failed (continuing without it): {qr_err}")
