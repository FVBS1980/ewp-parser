...
SKU_MAP = {
    ...
    '14" BCI 90-2.0 DF':'BCI9014','16" BCI 90-2.0 DF':'BCI9016',
    '9-1/2" BCI 90-2.0 DF':'BCI909','11-7/8" BCI 90-2.0 DF':'BCI9011',
    'HGUS414 Reverse':'8589107R','HUCQ1,81/11-SDS':'HUCQ18111SDS',
...
def parse_pdf(pdf_bytes):
    ...
    for raw in all_lines:
        ...
        if di > 0:
            ...
            elif cur_section in ('Floor Accessories', 'Roof Accessories') and is_joist(prod): pass
